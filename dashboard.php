...
$orderSql = "SELECT * FROM orders WHERE order_status = 1"; // statment query order table to find total order
$orderQuery = $connect->query($orderSql); // run query
$countOrder = $orderQuery->num_rows; // number_row is a function to count total order

$totalRevenue = 0;
while ($orderResult = $orderQuery->fetch_assoc()) { //fetch_assoc is a function to fetch data
